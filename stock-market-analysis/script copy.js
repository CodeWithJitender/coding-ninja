...
const stockDatabase = [
  ...
  },
  {
    ...
    "chart": {
      ...
      "3mo": {
        ...
        "_id": "669e00e450fc3e4309734f5b"
      },
      "_id": "669e00e450fc3e4309734f5c"
    }
  },
  {
    "symbol": "GOOGL",
    "desc": "Alphabet Inc. offers various products and platforms in the United States, Europe, the Middle East, Africa, the Asia-Pacific, Canada, and Latin America. It operates through Google Services, Google Cloud, and Other Bets segments. The Google Services segment provides products and services, including ads, Android, Chrome, hardware, Gmail, Google Drive, Google Maps, Google Photos, Google Play, Search, and YouTube. It is also involved in the sale of apps and in-app purchases and digital content in the Google Play store; and Fitbit wearable devices, Google Nest home products, Pixel phones, and other devices, as well as in the provision of YouTube non-advertising services. The Google Cloud segment offers infrastructure, cybersecurity, data, analytics, AI, and machine learning, and other services; Google Workspace that include cloud-based collaboration tools for enterprises, such as Gmail, Docs, Drive, Calendar, and Meet; and other services for enterprise customers. The Other Bets segment sells health technology and internet services. The company was founded in 1998 and is headquartered in Mountain View, California.",
    "price": 20.507,
    "change": 0.20584999,
    "chart": {
      "5y": {
  ...
  },
  {
    ...
    "chart": {
      ...
      "3mo": {
        ...
        "_id": "669e00e450fc3e4309734f65"
      },
      "_id": "669e00e450fc3e4309734f66"
    }
  },
  {
    "symbol": "PYPL",
    "desc": "PayPal Holdings, Inc. operates a technology platform that enables digital payments on behalf of merchants and consumers worldwide. The company provides payment solutions under the PayPal, PayPal Credit, Braintree, Venmo, Xoom, PayPal Zettle, Hyperwallet, PayPal Honey, and Paidy names. Its payments platform allows consumers to send and receive payments in approximately 200 markets and in approximately 150 currencies, withdraw funds to their bank accounts in 56 currencies, and hold balances in their PayPal accounts in 25 currencies. The company was founded in 1998 and is headquartered in San Jose, California.",
    "price": 17.699,
    "change": 0.09635,
    "chart": {
      "5y": {
  ...
  {
    "symbol": "NVDA",
    "desc": "NVIDIA Corporation provides graphics, and compute and networking solutions in the United States, Taiwan, China, and internationally. The companys Graphics segment offers GeForce GPUs for gaming and PCs, the GeForce NOW game streaming service and related infrastructure, and solutions for gaming platforms; Quadro/NVIDIA RTX GPUs for enterprise workstation graphics; vGPU software for cloud-based visual and virtual computing; automotive platforms for infotainment systems; and Omniverse software for building 3D designs and virtual worlds. Its Compute & Networking segment provides Data Center platforms and systems for AI, HPC, and accelerated computing; Mellanox networking and interconnect solutions; automotive AI Cockpit, autonomous driving development agreements, and autonomous vehicle solutions; cryptocurrency mining processors; Jetson for robotics and other embedded platforms; and NVIDIA AI Enterprise and other software. The companys products are used in gaming, professional visualization, datacenter, and automotive markets. NVIDIA Corporation sells its products to original equipment manufacturers, original device manufacturers, system builders, add-in board manufacturers, retailers/distributors, independent software vendors, Internet and cloud service providers, automotive manufacturers and tier-1 automotive suppliers, mapping companies, start-ups, and other ecosystem participants. It has a strategic collaboration with Kroger Co. NVIDIA Corporation was incorporated in 1993 and is headquartered in Santa Clara, California.",
    "price": 9.915,
    "change": 0.18521,
    "chart": {
      "5y": {
...
// Company name lookup mapping symbols to names
const companyNames = {
  AAPL: "Apple Inc.",
...
// Timeframe map between UI states and API properties
const TIMEFRAME_MAP = {
  "1M": "1mo",
  "3M": "3mo",
  "1Y": "1y",
...
// Number formatter supporting standard US formatting for charts and decimal/fraction mapping for database prices
function formatPriceString(val, isChartVal = false) {
...
function updateStockChart() {
  ...
  const apiTimeframe = TIMEFRAME_MAP[activeTimeframe];
  const chartData = activeStock.chart[apiTimeframe];
  const dataPoints = chartData.value;
  const labels = chartData.timeStamp.map(ts => {
    const dateObj = new Date(ts * 1000);
    if (activeTimeframe === "1M" || activeTimeframe === "3M") {
  ...
  const isUp = typeof activeStock.change === 'number' ? activeStock.change >= 0 : false;
        ...
        tooltip: {
          ...
          callbacks: {
            label: function (context) {
              ...
              return "Price: " + formatPriceString(value, true);
            },
          },
        },
      },
...
function updateDetailsUI() {
  ...
  setTimeout(() => {
    titleSpan.innerText = companyNames[activeStock.symbol] || activeStock.symbol;
...
function renderSidebarList() {
  ...
  stockDatabase.forEach((stock) => {
    ...
    const changeDirection = typeof stock.change === 'number' ? (stock.change >= 0 ? "up" : "down") : "down";
    const changeText = typeof stock.change === 'number' ? stock.change.toFixed(2) + "%" : "0.00%";

    const changeContainer = document.createElement("div");
    changeContainer.className = `stock-change ${changeDirection}`;
    changeContainer.innerText = changeText;
